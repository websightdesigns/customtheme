...
?>
	...
	<div id="footer">
		<div class="container">
			<p class="text-muted">&copy; Copyright <?php echo date('Y'); ?>. Some Rights Reserved. <?php printf( __( 'Website by %1$s.', 'customtheme' ), '<a href="http://www.websightdesigns.com/" rel="author" target="_blank">webSIGHTdesigns</a>' ); ?></p>
		</div>
	</div>
